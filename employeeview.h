...
public:
    ...
    void init_addFaultAndCostManagementMenu();
    void init_tabWidget();
...
private:
    ...
    QMenu *menu_faultAndCostMangement;
    ...
    QAction *action_ownerFault, *action_cost;
    ...
    EmployeeFaultWidget employeeFaultWidget;
    EmployeeCostWidget employeeCostWidget;
