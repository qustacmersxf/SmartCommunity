...
EmployeeModifyWidget::EmployeeModifyWidget(QWidget *parent) : QWidget(parent)
{
    QFont font;
...
void EmployeeModifyWidget::setInfo(int id, QString name, QString phone, QString password, QString homeAddress)
{
    this->id = id;
...
void EmployeeModifyWidget::slot_submit()
{
...
void EmployeeModifyWidget::slot_cancel()
{
    close();
}
